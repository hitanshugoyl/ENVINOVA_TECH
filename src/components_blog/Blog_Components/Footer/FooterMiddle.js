        ...
        <div>
            <Grid container spacing={0} style={{margin: "0px !important"}}>
                <Grid item xs={3} className={clsx(classes.gridItem, classes.gridItemOne)}>
                    ...
                    <br/>
                    <Typography className={classes.grid1typographyupper} variant="h5">
                        Secure payment transactions offered by Razorpay
                    </Typography>
                </Grid>
                ...
                <Grid item xs={3} className={classes.gridItem}>
                    <div className={classes.list}>
                        <ul className={classes.list}>
                            <a href="#" className={classes.anchor}><li className={classes.listItem}>Privacy Policy</li></a>
                            <a href="#" className={classes.anchor}><li className={classes.listItem}>Legal Disclaimer</li></a>
                            <a href="#" className={classes.anchor}><li className={classes.listItem}>Terms of Use</li></a>
